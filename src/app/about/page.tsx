...
import { useAboutContent } from '@/hooks/use-structured-content'

export default function Page() {
	const { data: remoteAbout } = useAboutContent()
	...
	const githubLink = siteContent.socialButtons?.find(button => button.type === 'github')?.value || 'https://github.com/yourname/your-blog'

	useEffect(() => {
		if (!remoteAbout || isEditMode) return
		setData(remoteAbout)
		setOriginalData(remoteAbout)
	}, [remoteAbout, isEditMode])
			...
			<div className='flex flex-col items-center justify-center px-6 pt-32 pb-12 max-sm:px-0'>
				<div className='w-full max-w-[800px]'>
					...
					<div className='mt-8 flex items-center justify-center gap-6'>
						...
						<LikeButton target='about' targetType='page' delay={0} />
					</div>
				</div>
			</div>
