			...
			<form onSubmit={handleSubmit} className='space-y-4'>
				<div>
					...
					<div
						...
						className='mx-auto flex h-32 w-32 cursor-pointer items-center justify-center rounded-xl border bg-[var(--surface-soft)] transition-colors hover:bg-[var(--surface-hover)]'>
						{previewFile ? (
