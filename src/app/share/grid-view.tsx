...
export default function GridView({ shares, isEditMode = false, onUpdate, onDelete, getLikeState, onLikeStateChange, readOnlyLike = false, className = 'mx-auto w-full max-w-7xl px-6 pt-24 pb-12' }: GridViewProps) {
